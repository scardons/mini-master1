...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap styles -->
    <link href="<?php echo URL;?>html/assets/css/bootstrap.css" rel="stylesheet"/>
    <!-- Customize styles -->
    <link href="<?php echo URL;?>html/style.css" rel="stylesheet"/>
    <!-- font awesome styles -->
	<link href="<?php echo URL;?>html/assets/font-awesome/css/font-awesome.css" rel="stylesheet">
		<!--[if IE 7]>
	...
	<!-- Favicons -->
    <link rel="shortcut icon" href="<?php echo URL;?>html/assets/ico/favicon.ico">
  </head>
<body>
<!-- 
...
<div class="row">
	...
	<a class="logo" href="index.html"><span>Twitter Bootstrap ecommerce template</span> 
		<img src="assets/img/logo-bootstrap-shoping-cart.png" alt="PAPELERIA ZAFIRO">
	</a>
	</h1>
	</div>
	<div class="span4">
	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			...
			<li class="dropdown">
				<a data-toggle="dropdown" class="dropdown-toggle" href="<?php echo URL;?>userController/login"><span class="icon-lock"></span> Login <b class="caret"></b></a>
...
<div class="well well-small">
	<ul class="nav nav-list">
		<li><a href="products.html"><span class="icon-chevron-right"></span>Oficina</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Certificados</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Copias</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Escolar</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Lapiceros</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Cuadernos</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Pliegos</a></li>
